package com.iupp.iuppcontroller.Joystick;
...
public class Joystick extends FrameLayout {
    private static final String LOG_TAG = "JoystickTag";
    ...
    private Joystick.MotionConstraint motionConstraint = Joystick.MotionConstraint.NONE;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.jmedeisis.bugstick.R.styleable.Joystick);
            startOnFirstTouch = a.getBoolean(com.jmedeisis.bugstick.R.styleable.Joystick_start_on_first_touch, startOnFirstTouch);
//            forceSquare = a.getBoolean(Joystick_force_square, forceSquare);
            hasFixedRadius = a.hasValue(com.jmedeisis.bugstick.R.styleable.Joystick_radius);
            if (hasFixedRadius) {
                radius = a.getDimensionPixelOffset(com.jmedeisis.bugstick.R.styleable.Joystick_radius, (int) radius);
            }
            motionConstraint = Joystick.MotionConstraint.values()[a.getInt(com.jmedeisis.bugstick.R.styleable.Joystick_motion_constraint,
    ...
    @SuppressWarnings("unused")
    public Joystick.MotionConstraint getMotionConstraint() {
